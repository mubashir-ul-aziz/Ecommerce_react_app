            ...
            {wishlist.length > 0 ? (
              wishlist.map((product, index) => {
                ...
                return (
                  <div
                    key={index}
                    className=" child-div-border border-gray-200 cursor-pointer bg-white lg:w-1/4 md:w-1/2 p-4 w-full "
                  >
                    <Link to={`/product/${product.id}`} className=" block ">
                      ...
                      <div className="mt-4">
                        ...
                        <h2 className=" min-h-[60px] text-gray-900 title-font text-lg font-medium">
                          {title}
                        </h2>
                      </div>
                    </Link>{" "}
                    <div className=" cursor-auto flex items-center justify-between ">
                      ...
                      <div className=' cursor-pointer ' onClick={() => removeFromWishlist(product.id)}> <DeleteForeverIcon /> </div>
                      {/* <div
