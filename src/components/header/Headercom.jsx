...
const navigation = [
  ...
  {name: "video",path: "https://www.youtube.com/watch?v=m2fFde492Ew&ab_channel=TutorialsDev",},
  {name: "tailwind",path: "https://tailblocks.cc/",},
  {name: "product api",path: "https://fakestoreapi.com/docs",}
];
